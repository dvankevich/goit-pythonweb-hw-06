...
python main.py -a create -m Subject -n "Предмет_1"
python main.py -a create -m Subject -n "Предмет_2"
python main.py -a create -m Subject -n "Предмет_3"
python main.py -a create -m Subject -n "Предмет_4"
...
# Приклад виставлення оцінки (опціонально)
echo "--- Тестова оцінка ---"
